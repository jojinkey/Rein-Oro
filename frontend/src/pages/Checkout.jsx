 ...
 return (
  <main className="cart-page-main">
   <form onSubmit={handlePlaceOrder} className="checkout-page-layout">
    ...
    <section
     className="checkout-forms-column"
      ...
      <div style={{ display: "flex", flexDirection: "column", gap: "1.2rem" }}>
       ...
       <div className="contact-form-group">
        ...
        <input
         ...
         id="email"
         className="contact-form-input"
         placeholder="Order receipt destination"
         required
       ...
       <div className="checkout-form-row">
        <div className="contact-form-group">
         <label htmlFor="apartment" className="contact-form-label">
      ...
      <div className="checkout-form-row">
       ...
       >
        ...
        <p style={{ fontSize: "0.75rem", color: "var(--color-muted)" }}>
         Delivered in 4 to 6 business days. Fully tracked.
        </p>
       </div>
       ...
       >
        ...
        <p style={{ fontSize: "0.75rem", color: "var(--color-muted)" }}>
         Delivered in 2 to 3 business days. Priority priority.
        </p>
       </div>
      </div>
     </div>
