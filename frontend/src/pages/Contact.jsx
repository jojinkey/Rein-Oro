    ...
    <main className="cart-page-main" style={{ minHeight: '90vh' }}>
      ...
      <div className="contact-grid">
        ...
        <section className="contact-info-card">
          ...
          <div className="contact-info-group">
            <span className="contact-info-icon">
              <svg xmlns="http://www.w3.org/2000/svg" width="20" height="20" viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth="1.5" strokeLinecap="round" strokeLinejoin="round" className="lucide lucide-globe"><circle cx="12" cy="12" r="10"/><path d="M12 2a14.5 14.5 0 0 0 0 20 14.5 14.5 0 0 0 0-20"/><path d="M2 12h20"/></svg>
            </span>
            <div className="contact-info-details">
