...
export default function Home() {
 ...
 useSEO({
  ...
  description:
   "Experience the gold standard of healthy snacking. Organic, slow-roasted, and double-sorted makhana and dry fruits fit for royalty.",
  ...
  const setupAnimations = () => {
   ...
   mainTimeline.to(
    airpodsRef.current,
    {
     ...
     onUpdate: () => {
      const currentImg =
       imagesRef.current[Math.round(airpodsRef.current.frame)];
     ...
     <div className="scenes-container">
      ...
      <div id="scene-1" className="scene" style={{ display: "flex" }}>
       <div className="scene-content text-center">
        <span className="eyebrow">
         {getCMSValue("index.html", "#scene-1 .eyebrow", "Gourmet Selection")}
        </span>
        ...
        <p className="body-text">
         {getCMSValue("index.html", "#scene-1 p", "Purity Crowned In Gold.")}
        </p>
       </div>
      </div>
      ...
      <div id="scene-2" className="scene">
       <div className="scene-content text-left">
        <span className="eyebrow">
         {getCMSValue("index.html", "#scene-2 .eyebrow", "Artisanal Craft")}
        </span>
        <h2 className="headline">
         {getCMSValue(
          "index.html",
          "#scene-2 h2",
          "Carefully Selected. Slowly Roasted.",
         )}
        </h2>
        <p className="body-text">
         {getCMSValue(
          "index.html",
          "#scene-2 p",
          "Sourced from organic wetlands, handpicked and slow-roasted to preserve natural minerals.",
         )}
        </p>
       </div>
      </div>
      ...
      <div id="scene-3" className="scene">
       <div className="scene-content text-right">
        <span className="eyebrow">
         {getCMSValue("index.html", "#scene-3 .eyebrow", "Royal Heritage")}
        </span>
        <h2 className="headline">
         {getCMSValue(
          "index.html",
          "#scene-3 h2",
          "A Royal Heritage of Culinary Excellence.",
         )}
        </h2>
        <p className="body-text">
         {getCMSValue(
          "index.html",
          "#scene-3 p",
          "Inspired by ancient wellness diets, curated to satisfy the modern gourmet palate.",
         )}
        </p>
       </div>
      </div>
      ...
      <div id="scene-4" className="scene">
       <div className="scene-content text-left">
        <span className="eyebrow">
         {getCMSValue("index.html", "#scene-4 .eyebrow", "Pure Wellness")}
        </span>
        <h2 className="headline">
         {getCMSValue(
          "index.html",
          "#scene-4 h2",
          "Nourishment Fit for Royalty.",
         )}
        </h2>
        <p className="body-text">
         {getCMSValue(
          "index.html",
          "#scene-4 p",
          "Packed with antioxidants, high protein, and zero compromises on taste.",
         )}
        </p>
       </div>
      </div>
      ...
      <div id="scene-5" className="scene">
       <div className="scene-content text-center">
        <span className="eyebrow">
         {getCMSValue("index.html", "#scene-5 .eyebrow", "Rein Oro House")}
        </span>
        <h2 className="headline">
         {getCMSValue("index.html", "#scene-5 h2", "Purity Crowned in Gold.")}
        </h2>
        <p className="body-text">
         {getCMSValue(
          "index.html",
          "#scene-5 p",
          "Experience gourmet dry fruits and makhanas prepared for the royal in you.",
         )}
        </p>
    ...
    <div className="gifting-container">
     <div className="gifting-text-col">
      <h2 className="gifting-title">
       {getCMSValue("index.html", ".gifting-title", "Royal Corporate Gifting")}
      </h2>
      <p className="gifting-body">
       {getCMSValue(
        "index.html",
        ".gifting-body",
     ...
     <div className="gifting-image-col">
      <img
       src={getCMSValue("index.html", ".gift-box-img", "images/gift_box.png")}
       alt="Rein Oro Royal Gift Box"
