...
export default function ProductDetails() {
 ...
 const displayPrice = product
  ? getPriceForWeight(product.price, selectedWeight)
  : 0;

 // SEO dynamic meta tags
 useSEO({
  title: product
   ? `${product.title} | Rein Oro — Premium Makhana`
   : "Loading Product... | Rein Oro",
  description: product
   ? product.description
   : "Sourced from organic wetlands, handpicked and slow-roasted dry fruits fit for royalty.",
 ...
 const gallery = [
  ...
  product.image.includes("makhana")
   ? "/images/makhana_classic.png"
   : "/images/almonds_california.png",
  ...
  >
   ...
   <div className="product-hero-container">
    ...
    <div className="product-gallery">
     <div className="gallery-wrapper">
      ...
      <div className="gallery-main-img">
       <img id="main-product-display" src={selectedImg} alt={product.title} />
      </div>
     </div>
    </div>
    ...
    <section className="product-info-panel">
       ...
       {["100g", "250g", "500g", "1kg"].map((w) => (
        <button
         ...
         style={{
          fontSize: "0.8rem",
          color:
           selectedWeight === w ? "var(--color-white)" : "var(--color-muted)",
          fontWeight: 600,
          border:
           selectedWeight === w
          ...
          borderRadius: "2px",
          backgroundColor:
           selectedWeight === w ? "rgba(201,168,76,0.1)" : "transparent",
          cursor: "pointer",
          transition: "all 0.2s",
         }}
        >
     ...
     <div className="ingredients-wrapper" style={{ marginTop: "1rem" }}>
      ...
      <div
       className="ingredients-circles-row"
       style={{ display: "flex", gap: "1.5rem", flexWrap: "wrap" }}
      >
       {product.ingredients.map((ing, i) => (
        <div
         key={i}
         className="ingredient-circle-item"
         style={{
          display: "flex",
        ...
        >
         <div
          className="ingredient-img-frame"
          style={{
           width: "48px",
           height: "48px",
           borderRadius: "50%",
   ...
   >
    ...
    <div className="tab-panels-wrapper" style={{ paddingTop: "2rem" }}>
     {activeTab === "desc" && (
      <div
       className="tab-panel active-tab-panel description-paragraphs"
       style={{
        color: "var(--color-muted)",
        fontSize: "0.92rem",
        lineHeight: 1.7,
      ...
      >
       <p>
        {product.title} is an premium gourmet snack prepared for the most
        discerning palates. Slow-roasted in small batches using premium seeds
        and kernels, each bite offers an optimal crunch and pristine flavor
        profile.
       </p>
       <p>
        Perfect for healthy daily snacks or curated corporate gifting, it is
        completely free from cholesterol, trans fats, or uncertified chemical
        additives. Enjoy pure taste, crowned in gold.
       </p>
      </div>
     )}
     ...
     {activeTab === "reviews" && (
      <div
       className="tab-panel active-tab-panel"
       style={{ color: "var(--color-muted)", fontSize: "0.92rem" }}
      >
       <div
        style={{
         display: "flex",
       ...
       >
        <div style={{ minWidth: "200px" }}>
         ...
         <p style={{ fontSize: "0.8rem", color: "var(--color-muted)" }}>
          Based on {reviewSummary.total || 124} connoisseur reviews
         </p>
        </div>
        ...
        >
         {[5, 4, 3, 2, 1].map((stars) => {
          ...
          return (
           ...
           >
            <span style={{ width: "40px", color: "var(--color-white)" }}>
             {stars} star
            </span>
            <div
             style={{
       ...
       >
        {(reviews.length
         ...
         : [
            {
             ...
             rating: 5,
             comment:
              "The cheese onion flavoring is sublime. Absolute premium crunch and texture.",
            },
            {
             name: "Meera Sen",
             ...
             rating: 5,
             comment:
              "Hands down the best makhana I have ordered in India. Beautifully packed and completely fresh.",
            },
            {
             ...
             rating: 4,
             comment:
              "Superb quality. The gold visual branding is premium and the shipping was fast.",
            },
           ]
        ).map((rev, idx) => (
         <div
         ...
         >
          ...
          >
           <strong style={{ color: "var(--color-white)", fontSize: "0.88rem" }}>
            {rev.name}
           </strong>
          ...
          <div
           style={{ display: "flex", gap: "0.1rem", marginBottom: "0.6rem" }}
          >
           {[1, 2, 3, 4, 5].map((star) => (
            <svg
             key={star}
             ...
             height="12"
             viewBox="0 0 24 24"
             fill={star <= rev.rating ? "var(--color-gold)" : "none"}
             stroke="var(--color-gold)"
            >
             <polygon points="12 2 15.09 8.26 22 9.27 17 14.14 18.18 21.02 12 17.77 5.82 21.02 7 14.14 2 9.27 8.91 8.26 12 2" />
            </svg>
    ...
    >
     ...
     >
      ...
      <div style={{ textAlign: "left" }}>
       ...
       <p
        style={{ fontSize: "0.72rem", color: "var(--color-gold)", margin: 0 }}
       >
        {product.flavor} &bull; {selectedWeight}
       </p>
      </div>
     </div>
