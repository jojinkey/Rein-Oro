...
export default function Contact() {
 ...
 useSEO({
  ...
  description:
   "Reach the House of Rein Oro concierge. Contact us for custom orders, corporate gifting inquiries, distribution opportunities, or client support.",
    ...
    <section className="contact-info-card">
     ...
     <div className="contact-info-group">
      ...
      <div className="contact-info-details">
       ...
       <p>
        <a
         href={`mailto:${getCMSValue("contact.html", ".contact-email-1", "concierge@reinoro.com")}`}
        >
         {getCMSValue(
          "contact.html",
          ".contact-email-1",
       ...
       <p>
        <a
         href={`mailto:${getCMSValue("contact.html", ".contact-email-2", "support@reinoro.com")}`}
        >
         {getCMSValue(
          "contact.html",
          ".contact-email-2",
     ...
     <div className="contact-info-group">
      ...
      <div className="contact-info-details">
       ...
       <p>
        Concierge:{" "}
        {getCMSValue("contact.html", ".contact-phone-1", "+91 99999 88888")}
       </p>
       <p>
        Support:{" "}
        {getCMSValue("contact.html", ".contact-phone-2", "+91 99999 77777")}
       </p>
      </div>
     </div>
