  ...
  return (
    <footer className="footer-section" id="footer-section">
      <div className="footer-container">
        ...
        <div className="footer-brand-col">
          <Link to="/" className="footer-logo">
            <img src="images/logo.png" alt="Rein Oro Logo" className="footer-logo-img" />
          </Link>
          ...
          <div className="social-links">
            ...
            <a href="#" aria-label="Pinterest">
              <svg xmlns="http://www.w3.org/2000/svg" width="16" height="16" viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2" stroke-linecap="round" stroke-linejoin="round" className="lucide lucide-pin"><line x1="12" y1="17" x2="12" y2="22" /><path d="M5 17h14v-1.76a2 2 0 0 0-.44-1.24l-2.33-2.92a3 3 0 0 1-.64-1.84V6a4 4 0 0 0-8 0v3.24c0 .68-.22 1.33-.63 1.84l-2.33 2.92A2 2 0 0 0 5 15.24Z" /></svg>
            </a>
          </div>
        </div>
        ...
        <div className="footer-links-col newsletter-col">
          <h4>Newsletter</h4>
          <p>Subscribe to get special offers, new launches and updates.</p>
      ...
      <div className="footer-bottom">
        <p>&copy; {new Date().getFullYear()} Rein Oro Luxury Foods. All rights reserved.</p>
        <div className="footer-bottom-links">
          <Link to="/terms">Terms & Conditions</Link> &bull; <Link to="/privacy">Privacy Policy</Link>
        </div>
        <div className="footer-bottom-payments" style={{ display: 'flex', gap: '0.6rem', alignItems: 'center', color: 'var(--color-muted)' }}>
          <span style={{ fontSize: '0.65rem', border: '1px solid rgba(255,255,255,0.12)', padding: '2px 6px', borderRadius: '3px', letterSpacing: '0.05em', fontWeight: 600, opacity: 0.6 }}>VISA</span>
          <span style={{ fontSize: '0.65rem', border: '1px solid rgba(255,255,255,0.12)', padding: '2px 6px', borderRadius: '3px', letterSpacing: '0.05em', fontWeight: 600, opacity: 0.6 }}>MASTERCARD</span>
          <span style={{ fontSize: '0.65rem', border: '1px solid rgba(255,255,255,0.12)', padding: '2px 6px', borderRadius: '3px', letterSpacing: '0.05em', fontWeight: 600, opacity: 0.6 }}>UPI</span>
          <span style={{ fontSize: '0.65rem', border: '1px solid rgba(255,255,255,0.12)', padding: '2px 6px', borderRadius: '3px', letterSpacing: '0.05em', fontWeight: 600, opacity: 0.6 }}>RUPAY</span>
        </div>
      </div>
    </footer>
  );
